...
protected:
      ...
      */
     Gate(Logic_Value (*logicFunc)(std::vector<Logic_Value>), std::vector<Input*> input_junction_ptrs, Output *output_junction_ptr);
...
public:
     ...
     GateNAND(std::vector<Input *> input_junction_ptrs, Output *output_junction_ptr) :

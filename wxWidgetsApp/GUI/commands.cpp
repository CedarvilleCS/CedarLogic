...
cmdMergeWire::cmdMergeWire(GUICircuit* gCircuit, GUICanvas* gCanvas, unsigned long wid1, unsigned long wid2, GLPoint2f mc) : klsCommand(true, (const wxChar *)"Connection") { // KAS
	this->gCircuit = gCircuit;
	this->gCanvas = gCanvas;
	this->wid1 = wid1;
	this->wid2 = wid2;

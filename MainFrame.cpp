       ...
       : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(600,600))
{
    ...
    // create a toolbar
	//////////////////////////////////////////////////////////////////////////
	toolBar = new wxToolBar(this, TOOLBAR_ID, wxPoint(0,0), wxDefaultSize, wxTB_HORIZONTAL|wxTB_FLAT|wxTB_DOCKABLE);
	...
	/* Test example for dynamic gate--hard-coded*/
	DynamicGate * dg;
	dg = new DynamicGate(currentCanvas, gCircuit, gCircuit->getNextAvailableGateID(), 10, "XOR", 0, 0);
}
